...
_RESETPLAYERPOSITIONSREQUEST = DESCRIPTOR.message_types_by_name['ResetPlayerPositionsRequest']
_RESETGAMEREQUEST = DESCRIPTOR.message_types_by_name['ResetGameRequest']
_RESETPLAYERPOSITIONSRESPONSE = DESCRIPTOR.message_types_by_name['ResetPlayerPositionsResponse']
_GAMESNAPSHOTREQUEST = DESCRIPTOR.message_types_by_name['GameSnapshotRequest']
_GAMESNAPSHOTRESPONSE = DESCRIPTOR.message_types_by_name['GameSnapshotResponse']
...
ResetPlayerPositionsRequest = _reflection.GeneratedProtocolMessageType('ResetPlayerPositionsRequest', (_message.Message,), {
  'DESCRIPTOR' : _RESETPLAYERPOSITIONSREQUEST,
  '__module__' : 'remote_pb2'
  # @@protoc_insertion_point(class_scope:lugo.ResetPlayerPositionsRequest)
  })
_sym_db.RegisterMessage(ResetPlayerPositionsRequest)

ResetGameRequest = _reflection.GeneratedProtocolMessageType('ResetGameRequest', (_message.Message,), {
  'DESCRIPTOR' : _RESETGAMEREQUEST,
  '__module__' : 'remote_pb2'
  # @@protoc_insertion_point(class_scope:lugo.ResetGameRequest)
  })
_sym_db.RegisterMessage(ResetGameRequest)

ResetPlayerPositionsResponse = _reflection.GeneratedProtocolMessageType('ResetPlayerPositionsResponse', (_message.Message,), {
  'DESCRIPTOR' : _RESETPLAYERPOSITIONSRESPONSE,
  '__module__' : 'remote_pb2'
  # @@protoc_insertion_point(class_scope:lugo.ResetPlayerPositionsResponse)
  })
_sym_db.RegisterMessage(ResetPlayerPositionsResponse)

GameSnapshotRequest = _reflection.GeneratedProtocolMessageType('GameSnapshotRequest', (_message.Message,), {
  'DESCRIPTOR' : _GAMESNAPSHOTREQUEST,
  '__module__' : 'remote_pb2'
  # @@protoc_insertion_point(class_scope:lugo.GameSnapshotRequest)
  })
_sym_db.RegisterMessage(GameSnapshotRequest)

GameSnapshotResponse = _reflection.GeneratedProtocolMessageType('GameSnapshotResponse', (_message.Message,), {
  'DESCRIPTOR' : _GAMESNAPSHOTRESPONSE,
  '__module__' : 'remote_pb2'
  # @@protoc_insertion_point(class_scope:lugo.GameSnapshotResponse)
  })
_sym_db.RegisterMessage(GameSnapshotResponse)
